...
\speech{Der Energieerhaltungssatz}{1}{ % ToDo: dieser Teil soll bei only 1 kommen
...
\speech{Der Energieerhaltungssatz}{1}{ % ToDo: Dieser Teil soll bei only 2 kommen
	Zusammenfassung:
	Energie ist eine Erhaltungsgröße.
...
\speech{test}{1}{ %ToDo: Die Klammern sind hier lila und oben gelb. Muss irgendwo ein Fehler sein. (Vielleicht auch nicht. Farbe Ändert sich, sobald {{}})
...
\speech{test2}{1}{ % ToDo: auch hier muss ein Fehler vorliegen, da die Klammern lila sind.
