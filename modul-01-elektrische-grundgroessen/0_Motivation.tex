...
\begin{frame}{}
	...
	\begin{Lernziele}{Beschreibung physikalischer Größen}
        ...
        \end{itemize}
    \end{Lernziele}
	\speech{Lernziele_groessen}{1}{Jeweils zu Beginn und Ende eines jeden Kapitels sollen die konkreten Lernziele für dieses definiert werden, um Ihnen auf der einen Seite schon
	 jetzt zu zeigen, was in diesem Kapitel auf 
	Sie zukommen und besonders wichtig sein wird, und Ihnen auf der anderen Seite am Ende des Kapitels die Möglichkeit zu geben, zu rekapitulieren, ob die zentralen Inhalte des Kapitels verstanden wurden.
	Das erste Kapitel ist ein Einleitungskapitel, in welchem die Grundlagen zur korrekten Beschreibung aller physikalischer Größen, welche in der Elektrotechnik benötigt werden, beschrieben sind.
	Am Ende dieses Kapitels sollten Sie sämtliche physikalischen Größen mit Maßzahl sowie Maßeinheit angeben können, einen Überblick über die SI-Basiseinheiten sowie die ihnen zugeordneten abgeleiteten 
	Einheiten gewonnen haben, sowie sehr kleine beziehungsweise sehr große Zahlenwerte korrekt mit ihren Zehnerpotenzen angeben können.
	}
...
Diese Einheiten sind im internationalen Einheitensystem, dem S I System, definiert.Es gibt sieben S Ih Basisgrößen, welche
...
\speech{SI-Einheiten}{5}{In der Elektrotechnik besonders häufig vorkommend ist die elektrische Stromstärke I, die in Ampere angegeben wird.}
...
\speech{abgeleitete-einheiten}{5}{Weitere in den Grundlagen der Elektrotechnik wichtige Einheiten sind die Spannung U.}
\speech{abgeleitete-einheiten}{6}{Die Ladung Q wird in Coulomb angegeben.}
\speech{abgeleitete-einheiten}{7}{Der elektrische Widerstand R, gemessen in Ohm , .}
\speech{abgeleitete-einheiten}{8}{Die Kapazität C in Farad gibt beispielsweise die Speicherfähigkeit eines Kondensators an.}
\speech{abgeleitete-einheiten}{9}{Die Induktivität  in Henry ist die zentrale Eigenschaft einer Spule,.}
...
\begin{frame}
	...
	Eine andere Möglichkeit zur Verbesserung der Lesbarkeit ist die sogenannte Exponentialdarstellung.
	Dabei wird die Maßzahl mit der entsprechenden Zehnerpotenz direkt multipliziert. Die Anzahl der
	verwendeten Nachkommastellen muss physikalisch sinnvoll sein. Ist dazu nichts weiter bekannt, werden meist zwei Nachkommastellen verwendet.}
