...
\speech{Der Energieerhaltungssatz}{ % ToDo: Dieser Teil soll bei only 2 kommen
	Zusammenfassung:
	Energie ist eine Erhaltungsgröße.
...
\speech{}{ %ToDo: Die Klammern sind hier lila und oben gelb. Muss irgendwo ein Fehler sein.
...
\speech{ % ToDo: auch hier muss ein Fehler vorliegen, da die Klammern lila sind.
