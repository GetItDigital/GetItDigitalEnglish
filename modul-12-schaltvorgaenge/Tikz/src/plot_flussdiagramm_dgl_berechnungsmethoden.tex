...
\begin{tikzpicture}
    ...
    \draw[->](4.5,1) -- (7.5,1) node[pos=0.5, above]{ODE solve};
    \draw (8,0) rectangle (12,2);
    % Text Zeitbereich 1.Kasten
    \draw (2,1) node[align=center,text centered]{Differential equation\\%
    $\displaystyle{
        \sum_{i=0}^{n} a_i \cdot f^{(i)}  = b} 
    $};

    % Text Zeitbereich 2.Kasten
    \draw (10,1) node[align=center, text centered]{Time lapse function\\$\displaystyle{f(t)=... \vphantom{\sum_{i=0}^{n}}}$};
    ...
    \draw[->](4.5,-4) -- (7.5,-4) node[pos=0.5, above]{solve algebraically};
    ...
    \draw (2.5,-4.75) node[align=center,text centered]{\tiny Here for $f^{(i)}(0) = 0$};
    \draw (2,-4) node[align=center,text centered]{Algebraic equation\\%
    $\displaystyle{
        \sum_{i=0}^{n}a_i \cdot 
        \smash{
            %\underbrace{
    ...
    \draw (10,-4) node[align=center, text centered]{Image function\\$\displaystyle{F(s)=... \vphantom{\sum_{i=0}^{n}}}$};
    ...
    \draw(6,-1) node [align=center] {Time domain};
    \draw[dotted](3,-1.5)--(9,-1.5);
    \draw(6,-2) node [align=center] {Image area};
