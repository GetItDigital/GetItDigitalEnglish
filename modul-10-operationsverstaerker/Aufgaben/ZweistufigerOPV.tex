\subsection{Determine the output voltage of a two-stage operational amplifier circuit\label{Aufg15}}
% Alt: Aufgabe 15
\Aufgabe{
    Given is the following circuit. Calculate the output voltage \( U_\mathrm{a} \). \\
...
$
    \begin {figure} [H]
   \centering
   \input{Tikz/src/FigZweistufigerOPV.tex}
...
\Loesung{
    The output voltage after the first operational amplifier (\( U_\mathrm{a1} \)) is calculated as follows:
    \begin{align*}
    ...
    \end{align*}
    This results in the following for the total output voltage (\( U_\mathrm{a} \)):
    \begin{align*}
