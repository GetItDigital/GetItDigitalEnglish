\b{\begin{frame}
    \fta{Prinzip der Gegenkopplung}
        ...
        \fu{\resizebox{\textwidth}{!}{\input{Tikz/OPVBeispielproblem.tex}}}{Schaltung des Beispielproblems mit einer Signalquelle auf der Eingangsseite und einer komplexen Last auf der Ausgangsseite \label{fig:Beispielproblem 1 Folien}}.
\end{frame}}
...
%}
    ...
    \b{
        ...
        \fu{\resizebox{\textwidth}{!}{\input{Tikz/OPVBeispielproblem.tex}}}{Schaltung des Beispielproblems mit einer Signalquelle auf der Eingangsseite und einer komplexen Last auf der Ausgangsseite \label{fig:Beispielproblem 1 Folien 2}} 
    }
\end{frame}
...
\begin{frame}
    \b{
            \frametitle{Prinzip der Gegenkopplung - Lösung des Beispielproblems (2)}
             \fu{\resizebox{0.28\textwidth}{!}{\input{Tikz/Verschaltungdesverstaerkers_ersterTeil.tex}}}{Schaltung des Beispielproblems mit einer Signalquelle auf der Eingangsseite und einer komplexen Last auf der Ausgangsseite \label{fig:Beispielproblem 1 Folien 2 Abbildung 1}} 
        }
    \end{frame}
    \begin{frame}
        \b{
            \frametitle{Prinzip der Gegenkopplung - Lösung des Beispielproblems (2)}
             \fu{\resizebox{0.8\textwidth}{!}{\input{Tikz/Verschaltungdesverstaerkers_zweiterTeil.tex}}}{Schaltung des Beispielproblems mit einer Signalquelle auf der Eingangsseite und einer komplexen Last auf der Ausgangsseite \label{fig:Beispielproblem 1 Folien 2 Abbildung 2}} 
        }
    \end{frame}
...
\begin{frame}
    ...
    \fu{
        \resizebox{\textwidth}{!}{\input{Tikz/Verschaltungdesverstaerkers.tex}}
   ...
   \b{\frametitle{Prinzip der Gegenkopplung - Lösung des Beispielproblems (3)}
    \begin{columns}
        \column[c]{0.3\textwidth}
            \begin{center}
                \input{Tikz/Verschaltungdesverstaerkers_letzterTeil.tex}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/NichtinvertierenderVerstaerker.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangNiV.tex}}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/InvertierenderVerstaerker.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangInvertierenderVerstaerker.tex}}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Komparator.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangKomparator.tex}}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Summierer.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangSummierer.tex}}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Subtrahierer.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangSubtrahierer.tex}}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Integrierer.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangIntegrierer.tex}}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Differenzierer.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangDifferenzierer.tex}}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Potenzierer.tex}}
...
\begin{frame}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Instrumentenverstaerker.tex}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/FrequenzgangInstrumenten.tex}}
...
\begin{frame}
    ...
    \vspace{0.5cm}
    \centering
    \scalebox{0.45}{\input{Tikz/Impedanzwandler.tex}}
     &
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}
        \centering
        \resizebox{0.6\linewidth}{!}{\input{Tikz/Impedanzwandler.tex}}
