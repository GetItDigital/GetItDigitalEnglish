...
\Aufgabe{
    ...
    \begin{figure}[H]
    \centering
    \input{Tikz/FigSpannungsueberwachungLED.tex}
...
\Loesung{
             ...
             \begin{figure}[H]
             \centering
             \input{Tikz/LsgSpannungsueberwachungLED1.tex}
        ...
        \begin{figure}[H]
        \centering
        \input{Tikz/LsgSpannungsueberwachungLED2.tex}
        \label{fig:LsgSpannungsueberwachungLED2}
        \end{figure}

        \begin{figure}[H]
        \centering
        \input{Tikz/LsgSpannungsueberwachungLED3.tex}
