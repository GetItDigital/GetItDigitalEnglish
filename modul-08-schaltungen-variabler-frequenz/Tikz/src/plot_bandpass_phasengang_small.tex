...
\begin{tikzpicture}[x=1mm,y=1mm] % gilt für tikz-coordinaten außerhalb der axis-environment
    \draw[draw=none] (-16,-13) rectangle (90,36); % Bildrahmen, Koordinatenbezug auf (0,0) des \begin{axis}...\end{axis} pgfplots, für
    \begin{semilogxaxis}[
        %title={Bandpass},
        ...
        % Bereiche
        \node at (10^1,45) [anchor=north] {Hochpass};
        \node at (10^3,45) [anchor=north] {Übergang};
        \node at (10^5,45) [anchor=north] {Tiefpass};
