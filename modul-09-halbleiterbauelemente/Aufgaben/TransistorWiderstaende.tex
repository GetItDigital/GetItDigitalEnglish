\subsection{Calculation of the resistances of a transistor circuit\label{Aufg13}}
% Alt: Aufgabe 13
\Aufgabe{
  The transistor circuit shown has the following parameters: $U_0=\mathrm{5\,V}$ , 
  ...
  In order for the silicon transistor shown to switch, it needs a base current of$50 \, \mathrm{\mu A}$ to 
  switch through.
  ...
  \begin{itemize}
    \item[a)] How large must the resistance $R_\mathrm{V}$ be selected so that the transistor switches through?
    \item[b)] Assuming that the voltage drop across the transistor $U_\mathrm{CE}$ is $7,5 \, \mathrm{V}$, how large is the current
          through $I_\mathrm{E}$?
  \end{itemize}
