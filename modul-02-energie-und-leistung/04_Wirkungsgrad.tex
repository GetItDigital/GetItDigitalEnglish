...
\s{\begin{figure}[H]
		...
		\input{Tikz/src/Kapitel 5/Wirkungsgrad eines Elektromotors.tex}
...
\begin{figure}[H]
	...
	\input{Tikz/src/Kapitel 5/Energieumwandlung in Glühlampe und Energiesparlampe.tex}
...
\hspace{1cm} % Um es in der Mitte zu haben
	...
	\input{Tikz/src/Kapitel 5/Beispiel Schaltung Wirkungsgrad.tex}
...
\begin{figure}[H]
	...
	\input{Tikz/src/Kapitel 5/Einfache Schaltung.tex}
