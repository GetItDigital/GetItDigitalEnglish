...
\input{Kapitel0}    % Wiederholung
\newpage

\input{Kapitel1}    % Frequenzgang, Amplitudengang, Phasengang
\newpage

\input{Kapitel2}    % Logarithmische Darstellung Frequenzgang
\newpage

\input{Kapitel3}    % Ortskurven
\newpage

\input{Kapitel4}    % Resonanzkreise, Schwingungen, Ortskurven
...
\begin{frame}{\secname}
    ...
    % Nebenrechnung 1
    Frequency response of a first-order RC low-pass filter. [Additional calculation for equation \eqref{eq:tiefpass:frequenzgang}]
    \begin{equation}
        \begin{aligned}
            \underline{F}(\mathrm{j}\omega)
                & = \frac{\underline{U}_2}{\underline{U}_1}
                    ...
                    &&\ \text{Complex voltage divider rule}\\
                ...
                &= \frac{1}{1 + \mathrm{j}\omega CR}
                    ...
                    &&\ \text{Optional for Cartesian form}\\
