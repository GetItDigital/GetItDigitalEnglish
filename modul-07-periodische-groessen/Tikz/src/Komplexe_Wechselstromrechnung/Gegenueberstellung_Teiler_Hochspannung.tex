\begin{circuitikz}
    ...
    \draw (1,0) node [label=below:Ohmic divider]{};
    ...
    \draw (5.5,0) node [label=below:Ohmic capacitive divider]{};
    ...
    \draw (10,0) node [label=below:Capacitive divider]{};
    ...
    \draw (14.5,0) node [label=below:Damped capacitive divider]{};
\end{circuitikz}