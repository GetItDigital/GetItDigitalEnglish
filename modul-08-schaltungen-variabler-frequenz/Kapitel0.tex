...
\s{% Skript-only
    ...
    \begin{figure}[H]\centering
        ...
        \end{subfigure}%
        \begin{subfigure}{0.28\textwidth}\centering
            \input{Tikz/src/circ_bauteil_C_u_i.tex}% C
...
\column{0.15\textwidth}\centering
    \input{Tikz/src/circ_bauteil_L_u_i_mini.tex}% Schaltsymbol
    \vspace{2cm}
    \input{Tikz/src/circ_bauteil_C_u_i_mini.tex}% Schaltsymbol
...
\begin{frame}\ftx{\subsubsecname}
    ...
    \begin{tabular}{ |c|c|c|c|c| }
        ...
        \hline%
        %\textbf{Symbol}
        \input{Tikz/src/circ_bauteil_tabelle_text_symbol.tex}% Symbol (vertikal zentriert)
                & \input{Tikz/src/circ_bauteil_tabelle_zweipol.tex}
                & \input{Tikz/src/circ_bauteil_tabelle_R.tex}
                & \input{Tikz/src/circ_bauteil_tabelle_L.tex}
                & \input{Tikz/src/circ_bauteil_tabelle_C.tex} \\[+4pt]
        \hline &&&&\\[-6pt]
        %\textbf{Bauteil}
        %        & Zweipol
        %        & Widerstand
