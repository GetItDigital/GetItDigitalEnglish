...
Liegt eine solche gerichtete Bewegung von Teilchen vor, wird von einem \textbf{Strömungsfeld} gesprochen.
 ...
 \begin{figure}[h!]
	\centering
	\includesvg[width=0.6\textwidth]{strömungsfeld.svg}
...
\begin{frame}
	...
	\begin{columns}
	   ...
	   Stationäres elektrisches Strömungsfeld: strömende Teilchen \textbf{elektrische Ladungsträger}
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{strömungsfeld.svg}
...
jedoch in die zur Driftgeschwindigkeit der Elektronen entgegengesetzen Richtung (siehe Abbildung \ref{fig:strom}). 
 ...
 \begin{figure}[h!]
	\centering
	\includesvg[width=0.6\textwidth]{strom.svg}
...
\begin{figure}[h!]
	\centering
	\includesvg[width=0.6\textwidth]{strom1.svg}
...
\begin{figure}[h!]
	\centering
	\includesvg[width=0.6\textwidth]{stromdichte.svg}
...
\begin{frame}
	...
	$\Delta Q = e \cdot n_\mathrm{el} \cdot b_\mathrm{el} \cdot E \cdot \Delta t \cdot A$
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{strom1.svg}
...
$ I = e \cdot n_\mathrm{el} \cdot b_\mathrm{el} \cdot E  \cdot A$\\
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{strom.svg}
...
\end{equation*}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=\textwidth]{stromdichte.svg}	
	\end{figure}
