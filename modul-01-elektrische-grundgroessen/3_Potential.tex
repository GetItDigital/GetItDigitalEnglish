...
\begin{frame}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=0.5\textwidth]{homogenfeld_w.svg}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=0.5\textwidth]{homogenfeld_elektr_arbeit.svg}
...
$Q$ vom Ort $x$ der Probeladung linear abhängig ist (siehe Abbildung \ref{fig:zusammenhangEA}). Verfügt die Probeladung
 ...
 \begin{figure}[h!]
	\centering
	\includesvg[width=0.5\textwidth]{homogenfeld_elektr_arbeit2.svg}
...
\begin{figure}[h!]
	\centering
	\includesvg[width=0.5\textwidth]{energieumwandlung.svg}
...
Dazu wird die potentielle Energie auf ein Arbeitspotential normiert. 
 ...
 \end{equation*}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=\textwidth]{homogenfeld_w_folien.svg}
	%	\caption{Probeladung $Q$ in einem elektrischen Homogenfeld $\vec{E}$}
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=\textwidth]{homogenfeld_w_graph_folien.svg}
	%	\caption{Probeladung $Q$ in einem elektrischen Homogenfeld $\vec{E}$}
	\end{figure}
...
%			\end{eq}
 ...
 \column[c]{0.5\textwidth}
	   	...
	   	\begin{figure}[h!]
				\centering
				\includesvg[width=0.75\textwidth]{energieumwandlung.svg}
			%	\caption{Probeladung $Q$ in einem elektrischen Homogenfeld $\vec{E}$}
			%	\label{fig:anziehende_ladungen}
			\end{figure}	
			}
...
Dadurch wird diese beschleunigt, und die potenzielle Energie wird in kinetische Energie
 umgewandelt. Je weiter oben sich die Probeladung also im Homogenfeld befindet, desto mehr potentielle Enerwie ist gespeichert. Das Elektrische Feld wird hier negativ eingezeichnet,
da die Feldlinien der hier gewählten Zählrichtung von X entgegenstehen.}
...
\begin{frame}
	...
	\label{eq:potential}
	 ...
	 \begin{figure}[h!]
		\centering
		\includesvg[width=0.5\textwidth]{potential_homogenfeld.svg}
	...
	\end{figure}
	 ...
	 \begin{figure}[h!]
		\centering
		\includesvg[width=0.5\textwidth]{homogenfeld_phi_graph.svg}
	...
	\begin{columns}
	 ...
	 %  Die potentielle Energie normiert auf die betrachtete Ladung $Q$ ist das
	  ...
	  \hspace{-2pt}Normierung der potentiellen Energie:
	   ...
	   \begin{figure}[h!]
		\centering
		\includesvg[width=0.8\textwidth]{potential_homogenfeld_folien.svg}
	...
	\end{figure}
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{homogenfeld_phi_graph_folien.svg}
	...
	Diese auf die betrachtete Ladung Q normierte potentielle Energie wird also als das Potential Phi
	...
	Wie Eingangs erwähnt, muss zur Bestimmung des elektrischen Potenzials im Raum wie auch Potential des Gravitationsfeldes ein Bezugspotential festgelegt werden.
...
\begin{frame}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=0.5\textwidth]{potentialdifferenz.svg}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=0.5\textwidth]{phi_diff_graph.svg}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=0.5\textwidth]{wirbelfrei.svg}
		\caption{Darstellung des Potentialverlaufs $\varphi(x)$ innerhalb des elektrischen Homogenfeldes}
	...
	\begin{bsp}{Arbeit im Radialfeld}{}
		...
		\begin{center}
		\includesvg[width=0.5\textwidth]{radialfeld.svg}	
		\end{center}
...
Folglich müssen etwa 8,99 Megajoule aufgewendet werden, um die Ladung $Q_1$ zu verschieben. 
	...
	\begin{columns}
      \column[c]{0.4\textwidth}
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{potentialdifferenz_folien.svg}
		\end{figure}
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=0.8\textwidth]{phi_diff_graph_folien.svg}
		\end{figure}
		}
	...
	\speech{zusammenhang_Arbeit_Poti}{1}{Im homogenen elektrischen Feld ist das Potential Phi ausschließlich von der Entfernung zur Bezugselektrode abhängig.
	Dies bedeutet, dass alle Flächen, die senkrecht zum Feld stehen, ein konstantes Potential haben. 
	...
	das Ergebnis W gleich Q mal Vieh 1. 
...
\begin{frame}
	...
	\ftx{Wirbelfreies Feld}
		...
		und Endpunkt und nicht vom Weg abhängig. Es ist ein „wirbelfreies“ Feld.
			...
			\column[c]{0.4\textwidth}
				\includesvg[width=1\textwidth]{wirbelfrei.svg}
...
\begin{frame}
	...
	\begin{equation*}
	 ...
	 \begin{figure}[h!]
		\centering
		\includesvg[width=0.3\textwidth]{spannung.svg}
	...
	Die elektrische Spannung $U$ kann in einem wie in Abbildung \ref{fig:spannunghomogen} dargestellten Homogenfeld wie folgt berechnet werden,
	  ...
	  \begin{figure}[h!]
		\centering
		\includesvg[width=0.4\textwidth]{spannung_homogenfeld.svg}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=0.4\textwidth]{homogenfeld_spannung_graph.svg}
	...
	gleiche Richtung, dürfen die Vektorpfeile eliminiert werden, andernfalls muss das Skalarprodukt verwendet werden: 
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=0.5\textwidth]{skalarprodukt.svg}
	...
	\begin{columns}
      \column[c]{0.65\textwidth}
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{spannung.svg}
		\end{figure}


		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{spannung_homogenfeld.svg}
		\end{figure}
	...
	und welcher Punkt auf Phi zwei das Ziel darstellt. Auch der Pfad, welcher zwischen den Punkten gewählt wird, ist für die Spannung zwischen
	den Punkten unerheblich.}
...
\begin{frame}
	...
	\phantom{text}\\
		...
		\begin{figure}[h!]
			\centering
			\includesvg[width=\textwidth]{homogenfeld_spannung_graph_folie.svg}
...
\begin{frame}
	...
	\begin{columns}
	  ...
	  \begin{figure}[h!]
		\centering
		\includesvg[width=0.7\textwidth]{homogenfeld_spannung_graph_folie.svg}
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includesvg[width=0.9\textwidth]{skalarprodukt.svg}
	...
	\speech{zusammenhang_spannung_feld2}{1}{
		...
		Während dieses Integral im Homogenfeld durch eine Multiplikation ermittelt werden kann, ist dies bei inhomogenen Feldern also nur durch das Lösen der Gleichung
