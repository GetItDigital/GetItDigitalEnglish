...
\begin{frame}
	\ftx{Learning objectives: Capacity and capacitor}
\begin{Learning objectives}{Capacity and capacitor}
	The Students
	\begin{itemize}
...
\begin{frame}
	\ftx{Electrical capacity}
	\b{
		\begin{itemize}
			\item The ideal plate capacitor
			\end{itemize}
	}
	\begin{figure}[H]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Ende - Formeln Kapazität	 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\subsection{The capacitor as a component}
...
\begin{frame}
	...
	\b{
		\begin{itemize}
			\item Different types and designs of capacitors
		\end{itemize}
	}
	\begin{figure}[H]
		\renewcommand{\figurename}{Figure}
...
\begin{itemize}
	\item Equivalent circuit diagram of a real capacitor
\end{itemize}
\begin{figure}[H]
	\begin{center}
...
\begin{frame}
	\ftx{Key point: The capacitor as a component}
	\begin {Key point}{}
...
\begin{frame}[t]
	...
	\b{
		\begin{itemize}
			\item Relative permittivity of various materials
		\end{itemize}
		\vspace{1cm}
	}
...
\begin{frame}[t]
\ftx{The electric flux density $\vec{D}$}
\b{
	\begin{equation*}
		...
		\only<2->{\begin{itemize}
			\item In static cases, polarization $P$ can often be neglected.
		\end{itemize}
		\vspace{2cm}
		}
...
\s{
\textbf{Introduction to time-dependent processes}
...
\begin{frame}[t]
\ftx{Switching behavior of a capacitor: Charging}
\b{
...
\begin{frame}[t]
	\ftx{Switching behavior of a capacitor: Discharging}
...
\begin{frame}
	\ftx{Sample calculation of capacity}
