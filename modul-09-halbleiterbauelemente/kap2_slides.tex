...
\begin{frame}
    \b{ \frametitle{Diode bei Wechselspannung}
     \begin{figure}[H]
            ...
            \centering
            \includesvg[width=0.9\textwidth]{Bilder/kap2/Einweggleichrichter/EinweggleichrichterTeil2.svg}  
             \end{minipage}
...
\begin{frame}
    \b{ \frametitle{Bipolartransistor -- Elektrisches Verhalten}
        \begin{figure}[H]
            \centering
            \includesvg[width= 0.65 \textwidth]{Bilder/kap3/BipolartransistorMitKollektor-Emitter-Spannung.svg}
...
\begin{frame}
    \b{ \frametitle{Bipolartransistor -- Elektrisches Verhalten}
        \begin{figure}[H]
            ...
            \begin{minipage}[c]{0.48\textwidth}
                \raggedleft
                \scalebox{1}{\includesvg[width=\textwidth]{Bilder/kap3/EingangskennlinieEinesNpnTransistors.svg}}
            \end{minipage}
...
\begin{figure}
    \centering
    \scalebox{0.9}{\includesvg[width= \textwidth]{Bilder/kap2/FolienStromsteuerungskennlinieKurvenschar.svg}}
\end{figure}
    }
\end{frame}
