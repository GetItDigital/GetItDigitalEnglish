...
\begin{frame} \ftx{Skin-effect}
    ...
    \begin{minipage}{0.45\textwidth}
        \b{
            Alternating current only utilises the surface of a conductor.\pause
...
\begin{frame}\ftx{Example: Skin-depth}
...
\nomenclature[FF]{$f$}{Frequency \nomunit{$\mathrm{Hz}$}}
\nomenclature[F0]{$\rho_{\mathrm{R}}$}{Specific resistance \nomunit{$\frac{\Omega\cdot \mathrm{mm}^2}{\mathrm{m}}$}}
\nomenclature[F0]{$\delta$}{Penetration depth into the conductor due to the skin effect (skin depth) \nomunit{$\mathrm{m}$}}
