...
\begin{frame}
	...
	\speech{folie23}{2}{Bei der realen Stromquelle ist der Innenwiderstand nicht unendlich groß, folglich fließt durch diesen ein Strom.
		...
		Der Strom durch den Innenwiderstand beträgt also die Spannung durch eben diesen Innenwiderstand.
...
\begin{frame}
	...
	\b{
		...
		\speech{folie25}{2}{ Beim Leerlaufversuch wird wieder angenommen, dass die Ausgangsklemmen offen sind, der Ausgangswiderstand also unendlich groß ist.
			Somit fließt der gesamte Strom Ih null durch den Innenwiderstand. An den dazu parallel anliegenden Klemmen stellt sich die Leerlaufspannung U Ell gleich R Ih mal I null ein.
