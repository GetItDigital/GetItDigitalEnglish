\subsection{Resistance calculation for inverting amplifier\label{Aufg3}}
% Alt: Aufgabe 3
\Aufgabe{
	The depicted circuit with an inverting amplifier is given. The resistor $R_\mathrm{2} = 1\,\mathrm{k\Omega}$.  
    What values must $R_\mathrm{1}$ have so that the gain is -10, -50, and -100?

    \begin {figure} [H]
   \centering
   \input{Tikz/src/FigWiderstandIV.tex}
...
\Loesung{
    ...
    \begin{eqa}
        V = - \frac{R_2}{R_1}
    \end{eqa}
    Rearrange formula according to $R_\mathrm{1}$:
    \begin{eqa}
        R_1 = - \frac{R_2}{V}
    \end{eqa}
    \begin{itemize}
