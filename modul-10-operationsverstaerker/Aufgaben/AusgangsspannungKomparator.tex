\subsection{Determining the output voltage of a comparator\label{Aufg9}}
% Alt: Aufgabe 9
\Aufgabe{
    The depicted comparator is given. The voltage $U_\mathrm{1}= \mathrm{8.25\,V}$ is constant. 
    What is the output voltage for $U_2 = \mathrm{0\,V; 4\,V; 8\,V; 8.2\,V; 8.249\,V; 8.251\,V; 8.3\,V; 10\,V}$?
