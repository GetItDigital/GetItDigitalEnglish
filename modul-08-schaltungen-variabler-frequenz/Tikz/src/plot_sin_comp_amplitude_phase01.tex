\def\myamplitude{0.50}% Amplitude of u2, relative to u1
\def\myphase{0.50} % Phase shift of u2, negatively absolute in pi to u1
\def\myomegaindex{0}% omega, relative to omega0=1 % no stretching of x-axis as x=omega*t
\begin{tikzpicture}
    % invisible boundbox
