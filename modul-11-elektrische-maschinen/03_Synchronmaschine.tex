...
\begin{frame} \ftx{Aufbau einer fremderregten Synchronmaschine}
	...
	\b{
		\fo{}{width=0.75\textwidth}{Aufbau_Synchronmaschine2}{
...
\begin{frame}\ftb{Feldverläufe}
	\s{	
		\fo{width=\textwidth}{}{Synchronmaschine_Feldverlaeufe}{
			\put(10.23,23.3){\input{Tikz/synchronmaschine_feldverlaeufe_drehfeld}
			}
	...
	\b{	
		\fo{}{height=0.8\textheight}{Synchronmaschine_Feldverlaeufe_a1}{
...
\b{ % Quasi-Animation für Vorlesungsdatei
	\begin{frame}\ftb{Feldverläufe}
		\fo{}{height=0.8\textheight}{Synchronmaschine_Feldverlaeufe_a2}{
	...
	\end{frame}
	\begin{frame}\ftb{Feldverläufe}
		\fo{}{height=0.8\textheight}{Synchronmaschine_Feldverlaeufe_a3}{
...
\begin{frame}\ftx{Drehmoment}
	\fu{
		\input{Tikz/drehmomentkennlinie_synchron}
...
\begin{frame}
	...
	\end{circuitikz}}{{\bf Komplexes einphasiges ESB eines Vollpolgenerators.} Beispielsweise im Netzbetrieb.}%selbst erstellt
\end{frame}
