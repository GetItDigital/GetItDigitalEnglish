...
\Aufgabe{
  ...
  Widerstand mit dem Wert von $R=200\,\Omega$ geschaltet.
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[h]{0.45\textwidth}
            \centering
            \includesvg[width=0.9\textwidth]{Bilder/Aufgaben/FigDiodeAP.svg}
        \end{subfigure}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \begin{subfigure}[h]{0.45\linewidth}
                \centering
                \includesvg[width=\textwidth]{Bilder/Aufgaben/LsgDiodeAP1.svg}
            \end{subfigure}
            \begin{subfigure}[h]{0.45\linewidth}
                \centering
                \includesvg[width=\textwidth]{Bilder/Aufgaben/LsgDiodeAP2.svg}
            \end{subfigure}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includesvg[width=0.45\linewidth]{Bilder/Aufgaben/LsgDiodeAP3.svg}
        \end{figure}
