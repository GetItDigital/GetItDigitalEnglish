...
\begin{figure}[H]\centering
	\begin{tikzpicture}
		% Gleichspannungsquelle Uq an Schalter, Schalterspannung u
		% Schaltung
	...
	\end{tikzpicture}
	\s{\caption{Schaltbild, Schalterspannung}}\b{Schalterspannung $\ecv{u(t)}$}
...
\begin{figure}[H]\centering
	\begin{subfigure}{0.48\textwidth}\centering
		...
		\s{\caption{Spannung bei idealem Schalter}}\b{Ideal: verlustlos, instantan}
		\label{fig:plot:schalter:ideal}
	\end{subfigure}\pause
	\begin{subfigure}{0.48\textwidth}\centering
		\includegraphics{Tikz/pdf/plot_switch_real.pdf}
		\s{\caption{Spannung bei realem Schalter}}\b{Real: Verluste, Latenzen}
