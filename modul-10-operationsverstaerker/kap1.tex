...
\begin{frame}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \input{Tikz/FigKomparatorschaltung.tex}
    \end{subfigure}

    \begin{subfigure}[b]{\textwidth}
        \centering
        \includesvg[width=0.6\textwidth]{Bilder/Aufgaben/FigAkkuUeberwachung.svg}
    \end{subfigure}
...
\begin{frame}
   \b{
    ...
    \begin{figure}[ht]
        \centering
        \fu{
            \resizebox{0.7\textwidth}{!}{\input{Tikz/Funktionsweise_OPV_ohnePfeile.tex}}
...
\begin{frame}
    ...
    \begin{minipage}{\textwidth}        
        \centering
        \fu{
            \resizebox{0.6\textwidth}{!}{\input{Tikz/Funktionsweise_OPV_1.tex}}
            } 
    ...
    \b{ %Figure 1.3 auf Folien
        ...
        \begin{figure}[ht]
                \centering
                \fu{
                \resizebox{0.7\textwidth}{!}{\input{Tikz/Funktionsweise_OPV_1_Teil1.tex}}
                }{Verhalten eines vereinfachten Operationsverstärkers bei Anlegen einer positiven Differenzspannung am Eingang.
...
\begin{frame}\b{
    ...
    \begin{figure}[ht]
            \centering
            \fu{
            \resizebox{0.7\textwidth}{!}{\input{Tikz/Funktionsweise_OPV_1_Teil2.tex}}
            }{Verhalten eines vereinfachten Operationsverstärkers bei Anlegen einer positiven Differenzspannung am Eingang. Die blauen Pfeile geben an, wie sich das Potential am Schaltungsknoten ggü. eines ausgeglichenen Eingangs $U_{\textnormal{Diff}}$~=~0 verschiebt.
...
\begin{frame}
  ...
  %  }
    ...
    \begin{figure}[ht]
            \centering
            \fu{
            \resizebox{0.6\textwidth}{!}{\input{Tikz/Funktionsweise_OPV_2.tex}}
    ...
    \end{figure}   
        ...
        \b{
            ...
            \begin{figure}[ht]
                \centering
                \fu{
                \resizebox{0.7\textwidth}{!}{\input{Tikz/Funktionsweise_OPV_2.tex}}
                }{Verhalten eines vereinfachten Operationsverstärkers bei Anlegen einer negativen Differenzspannung am Eingang. Die blauen Pfeile geben an, wie sich das Potential am Schaltungsknoten ggü. eines ausgeglichenen Eingangs $U_{\textnormal{Diff}}$~=~0 verschiebt.
...
\begin{frame}
    ...
    \begin{columns}
        \column[c]{0.3\textwidth}
            \resizebox{.7\totalheight}{!}{\input{Tikz/Funktionsweise_OPV_1_ohne_marker.tex}}
            Verstärker bei positiver Differenzspannung
            \resizebox{.7\totalheight}{!}{\input{Tikz/Funktionsweise_OPV_2.tex}}
