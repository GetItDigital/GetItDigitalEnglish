...
\begin{frame}
	...
	\begin{figure}[h!]
		\centering
		\b{\includesvg[width=0.8\textwidth]{atommodell_bohr.svg}}
		\s{\includesvg[width=0.8\textwidth]{atommodell_bohr.svg}}
...
\s{	Die \textbf{Ladung} $Q$ eines Protons und eines Elektrons ist betragsmäßig gleich und wird als 
    ...
    \begin{columns}
		...
		\begin{figure}[h!]
			\centering
			\b{\includesvg[width=\textwidth]{ionisierung.svg}}
			\s{\includesvg[width=0.6\textwidth]{ionisierung.svg}}
...
\begin{frame}
	...
	Die \textbf{Punktladung} dient als idealisiertes Modell einer Ladungsverteilung auf
	 ...
	 Die \textbf{Linienladungsdichte} $\lambda$ (lambda), angegeben in C/m, beschreibt die Verteilung der elektrischen
	  ...
	  \begin{figure}[h!]
		...
		\s{\includesvg[width=0.3\textwidth]{linienladung.svg}}
	...
	\begin{figure}[h!]
		...
		\s{\includesvg[width=0.4\textwidth]{flächenladung.svg}}
	...
	\begin{figure}[h!]
		...
		\s{\includesvg[width=0.4\textwidth]{raumladung.svg}}
	...
	\begin{columns}
		\column[c]{0.3\textwidth}
				...
				{\includesvg[width=0.7\textwidth]{linienladung.svg}}
	...
	\visible<2->{
			...
			{\includesvg[width=0.7\textwidth]{flächenladung.svg}}
		...
		\rule{.1mm}{0.7\textheight}
		 ...
		 \begin{figure}[h!]
			...
			{\includesvg[width=0.7\textwidth]{raumladung.svg}}
	...
	\ftb{Elektrische Leiter - Metalle}
		...
		Elektronen der Summe aller Protonen entspricht.
			...
			\begin{figure}[h!]
				...
				\s{\includesvg[width=0.4\textwidth]{metalle.svg}}
		...
		\begin{figure}[h!]
			...
			\s{\includesvg[width=0.7\textwidth]{leiter_ladung.svg}}
		...
		\begin{figure}[h!]
			...
			{\includesvg[width=\textwidth]{Metalle2.svg}}
		...
		\end{figure}
			...
			\begin{figure}[h!]
				...
				{\includesvg[width=0.7\textwidth]{e_ueberschuss.svg}}
				\label{fig:le_ueber}
			\end{figure}
		}
			\onslide<3->{
				\begin{figure}[h!]
					...
					{\includesvg[width=0.7\textwidth]{e_mangel.svg}}
					\label{fig:le_mangel}
				\end{figure}
				}
		}
...
\begin{frame}
	\ftb{Das Coulombsche Gesetz}
		...
		\begin{figure}[h!]
			\centering
			\s{\includesvg[width=0.7\textwidth]{kraft.svg}}
		...
		\begin{figure}[h!]
			\centering
			\only<1>{{\includesvg[width=0.7\textwidth]{kraft2.svg}}}
			\only<2>{{\includesvg[width=0.7\textwidth]{kraft.svg}}}
			\only<3>{{\includesvg[width=0.7\textwidth]{kraft.svg}}}
			\only<4>{{\includesvg[width=0.7\textwidth]{kraft.svg}}}
			\label{fig:coulomb}
		\end{figure}
