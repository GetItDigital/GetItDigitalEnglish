...
\begin{frame}
    \b{ \frametitle{Introduction}
        \begin{Learning objectives}{Semiconductor}
...
\b{\fta{Einführung}
\begin{itemize}
    \item Semiconductor devices are central to the functioning of numerous electronic devices such as computers, mobile phones, and solar cells.
    \item They are based on materials that are neither good conductors nor good insulators. Their mode of operation can be explained using the band model.
    \item This chapter explains the fundamentals of semiconductor technology.
\end{itemize}}
...
\newvideofile{Baendermodell}{Band model}
\begin{frame}
\b{\begin{columns}
    \frametitle{Band model}
    ...
    \column[c]{0.6\textwidth}
        \begin{itemize}
            \onslide<1->{
            \item The band model describes the electronic properties of solids and classifies the energy states of electrons into energy bands.}
            \onslide<2->{
            \item It helps to understand and explain the electrical, optical and magnetic properties of materials.}
            \onslide<3->{
            \item The model enables the explanation of conduction, insulation, semiconductor behaviour, and surface and interface states.}
            \onslide<4->{
            \item The illustration on the left shows the relationship between Bohr's atomic model and the band model.}  
            \end{itemize}
    \end{columns}
}
...
\begin{frame}
    \renewcommand{\figurename}{Figure}
    \b{
    \frametitle{Band modell}
    \begin{figure}[H]
        \centering
        \includesvg[width=\textwidth]{Bilder/kap1/UebergangVonEnergieniveausZuBaendern}
        \caption{\textbf{Übergang von Energieniveaus zu Bändern} Relationship between possible energy states depending on the number of atoms. From left to right: energy states of electrons in a single atom, two atoms (molecule), and a solid.}  
...
\begin{frame}
    \renewcommand{\figurename}{Figure}
    \b{
    \frametitle{Classification of materials}
    \begin{figure}[H]
        \centering
        \includesvg[width=\textwidth]{Bilder/kap1/BaendermodelleinesMaterialsbei0K}
        \caption{\textbf{Band model of a material at 0 K} Representation of the energy bands with corresponding labels and their alternative names.}  
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \onslide<3->{
        \item Materials can be categorized via the band gap. 
        }
    \end{itemize}}
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \caption{\textbf{Diamond lattice structure of silicon}}  
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \end{minipage}
        \caption{\textbf{Zinc blende lattice structure of GaAs}}  
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \onslide<2->{
        \item Compound semiconductors consist of two materials that exhibit semiconductor behavior in a specific combination.
        }
        \onslide<3->{
        \item Silicon is from group IV of the periodic table, compound semiconductors are typically from groups III and V.
        }
    \end{itemize}}
    ...
    \b{
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|p{1.7cm}|p{1.2cm}|p{2cm}|p{2.2cm}|p{2.2cm}|p{2.3cm}|}
                \hline
                \textbf{Material} & \textbf{Band- \newline gap \newline (eV)} & \textbf{Charge- \newline carrier density \newline (cm$^{-3}$)} & \textbf{Electron- \newline mobility \newline (cm$^2$/Vs)} & \textbf{Hole- \newline mobility \newline (cm$^2$/Vs)} & \textbf{Applications}\\
                \hline
                Si  & 1,1 & $10^{10} - 10^{15}$ & 1500 & 450 & Microchips, \newline Solar cells, sensors \\
                \hline
                Ge & 0,7 & $10^{13} - 20^{19}$ & 3900 & 1900 & Transistors, \newline Infrared detectors \\
                \hline
                GaAs & 1,43 & $10^6 - 10^8$ & 8500 & 400 & High-frequency circuits, LEDs, laser diodes \\
                \hline
                \end{tabular}
                \caption{Properties of various semiconductor materials}
    ...
    \b{
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|p{1.7cm}|p{1.2cm}|p{2cm}|p{2.2cm}|p{2.2cm}|p{2.3cm}|}
                ...
                \textbf{Material} & \textbf{Band- \newline gap \newline (eV)} & \textbf{Charge- \newline carrier density \newline (cm$^{-3}$)} & \textbf{Electron- \newline mobility \newline (cm$^2$/Vs)} & \textbf{Hole- \newline mobility \newline (cm$^2$/Vs)} & \textbf{Applications}\\
                \hline
                InP & 1,35 & $10^{16} - 10^{17}$ & 5000 - 7000 & 200 - 400 & Optoelectronics, \newline solar cells \\
                \hline 
                GaN & 3,4 & $10^{13} - 10^{17}$ & 1000 - 2000 & 50- 200 & Power- \newline electronics, LED lighting, displays \\
                \hline
                SiC & 3,0 & $10^{12} - 10^{16}$ & 800 - 1200 & 200 - 400 & Power- \newline electronics, \newline high-temperature- \newline applications \\ 
                \hline
                \end{tabular}
                \caption{Properties of various semiconductor materials}
                %\label{tab:EigenschaftenVerschiedenerHalbleitermaterialien}
...
\begin{frame}
    \renewcommand{\figurename}{Figure}
    \b{\frametitle{Charge carrier transport}
    \onslide<1->{
        \begin{minipage}[t]{0.48\textwidth}
            \begin{figure}[H]
                \centering
                ...
                \caption{\textbf{Lattice structure and band model of n-doped Si} N-doped silicon at T $=$ 0 K.}  
...
\begin{frame}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \begin{figure}[H]
            ...
            \caption{\textbf{Lattice structure and band model of p-doped Si} p-doped silicon at T $=$ 0 K.}  
...
\begin{frame}
    ...
    \begin{itemize}
        \onslide<1->{
        \item Thermal excitation can generate free electrons that contribute to charge carrier transport. 
        } \onslide<2->{
        \item Doping is the targeted introduction of foreign atoms with fewer valence electrons than the starting material.
        } \onslide<3->{
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \caption{\textbf{Drift current within a semiconductor}}  
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \caption{\textbf{Diffusion current within a semiconductor}}  
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \caption{\textbf{Influence of voltages on semiconductors}}  
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \caption{\textbf{Processes within a pn junction.}}  
...
\begin{frame}
    ...
    \end{figure}
          \begin{itemize}
            \onslide<1->{
        \item The binding of holes and electrons to their atoms limits the diffusion current.
            } \onslide<2->{
        \item The area in the middle is called the space charge zone (SCZ). There are no free charge carriers there, as the electrons and holes neutralize each other.
            } \onslide<3->{
        \item An electric field is created between the p- and n-doped areas.
            }
    \end{itemize}
    }
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \caption{\textbf{Processes within the pn junction.}}  
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \caption{\textbf{Influence of voltages on pn junction.} Space charge region at different applied voltages. Left: voltage in the forward direction. Right: voltage against the forward direction, reverse direction.}  
...
\begin{frame}
    ...
    \begin{itemize}
        \onslide<1->{
        \item The pn junction combines a p- and n-doped semiconductor layer.
        } \onslide<2->{
        \item There are no free charge carriers in the transition region; this region is called the space charge region.
        } \onslide<3->{
