% R in Reihe mit (R parallel L).
% t<0: Reihenschaltung kurzgeschlossen
% t>=0: Reihenschaltung an ideale Spannungsquelle u1
\begin{tikzpicture}
    ...
    %R+(R||C) Circuit
    \draw(0.5,2.11) 
        to[V, name=u1, v_>=$u_1$, !v](0.5,-0.5)
        to[short](6.25,-0.5) 
        to[L, l=$L$, name=L, v<=$u_L$, !vi](6.25,1.685)
        to[short, name=iL, i<_=$i_L$, -*, !i](5,1.685)
