...
\s{\begin{figure}[H]
		...
		\input{Tikz/src/04_Wirkungsgrad/Wirkungsgrad eines Elektromotors}
...
\begin{figure}[H]
	...
	\input{Tikz/src/04_Wirkungsgrad/Energieumwandlung in Glühlampe und Energiesparlampe}
...
\hspace{1cm} % Um es in der Mitte zu haben
	...
	\input{Tikz/src/04_Wirkungsgrad/Beispiel Schaltung Wirkungsgrad}
...
\begin{figure}[H]
	...
	\input{Tikz/src/04_Wirkungsgrad/Einfache Schaltung}
