\subsection{Monitoring a voltage with LEDs\label{Aufg1}}
% Alt: Aufgabe 1
\Aufgabe{
    The circuit shown is given; it is to be used to monitor the voltage $U_\mathrm{a}$. $U_\mathrm{a}$ may only lie within the following range: $\mathrm{4.75\,V} < U_\mathrm{a} < \mathrm{5.25\,V}$. If the voltage exceeds or falls below this range, 
    one of the LEDs should light up. Design the circuit.
    \begin{figure}[H]
    \centering
