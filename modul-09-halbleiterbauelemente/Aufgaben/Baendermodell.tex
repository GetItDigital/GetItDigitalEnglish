\subsection{Description of the bandpass\label{Aufg1} }
% Alt: Aufgabe 1
\Aufgabe{
  Describe in detail the band model of solids and its significance for distinguishing between 
  conductors, semiconductors and insulators. In particular, address the following aspects:
  \begin{itemize}
    \item Relevant bands and their occupation by charge carriers.
    \item Significance of the band gap and how it influences the electrical properties of materials.
    \item Influence of temperature changes on conductivity.
\end{itemize}
...
\Loesung{
    The band model explains the energy states that electrons can occupy in solids.
    In a single atom, the electron states are discrete energy levels.
    See: Section \ref{sec:Bändermodell}
