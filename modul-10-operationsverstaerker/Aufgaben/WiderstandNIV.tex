\subsection{Resistance calculation for non-inverting amplifiers\label{Aufg2}}
% Alt: Aufgabe 2
\Aufgabe{
	The depicted circuit with a non-inverting amplifier is given. The resistor $R_\mathrm{2} = 1\,\mathrm{k\Omega}$.  
