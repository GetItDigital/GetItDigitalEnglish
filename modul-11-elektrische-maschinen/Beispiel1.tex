\subsection{Direct current machine 1\label{AufgGM1}}
\Aufgabe{
    ...
    \begin{itemize}
        ...
        \item[d)]
        How big is the anchor resistance? $R_A$?
    \end{itemize}
}
...
\Loesung{
	\begin{itemize}
		...
		\end{align*}
		\item[b)]
        In motor operation, the efficiency is the ratio of mechanical power to electrical power. Both the armature power and the excitation power must be taken into account here.
		\begin{eqa}
