\subsection{Calculation of the output voltage of a two-stage operational amplifier circuit\label{Aufg6}}
% Alt: Aufgabe 6
\Aufgabe{
    Calculate $U_\mathrm{A}$ with the following values: \newline
...
The output voltage $U_\mathrm{A}$ is therefore:
    \begin{align*}
