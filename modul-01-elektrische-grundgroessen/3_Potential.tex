...
\begin{frame}
	...
	\begin{Learning objectives}{Das elektrische Potential}
        The Students can
        \begin{itemize}
...
\begin{frame}
    ...
    Section 4.1 that the electric field strength is the quotient of the force on a charge per charge (see equation \ref{eq:e_field}),
