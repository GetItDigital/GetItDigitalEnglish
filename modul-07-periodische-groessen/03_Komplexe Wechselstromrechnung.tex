...
\begin{frame}
    ...
    \b{
        \begin{itemize}
            \item<1-> Komplexer Widerstand an einem ohmschen Verbraucher
            \item<2-> Kein Blindanteil bei einem idealen ohmschen Widerstand
            \item<3-> Idealer komplexer Widerstand als reiner Wirkanteil
        \end{itemize}
    }
...
\begin{frame}
    \renewcommand{\figurename}{Figure}
    \ftx{Beispielaufgabe}
    \begin{expl}{Real Voltage source}{Reale Spannungsquelle:}
...
\begin{frame}
    \ftx{Beispielaufgabe}
    \begin{expl}{AC conversion}{Wechselquellenumwandlung:}
