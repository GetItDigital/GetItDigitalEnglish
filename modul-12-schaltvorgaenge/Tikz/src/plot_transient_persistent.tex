...
\begin{tikzpicture}[x=1cm,y=1cm]
	...
	\node<3->[align=center, anchor=south] at (transient) 	{\textbf{Transition}$\vphantom{\big|}$\\transient$\vphantom{\big|}$};
	\node<3->[align=center, anchor=south] at (persistent) {\textbf{Stationary}$\vphantom{\big|}$\\persistent$\vphantom{\big|}$};
