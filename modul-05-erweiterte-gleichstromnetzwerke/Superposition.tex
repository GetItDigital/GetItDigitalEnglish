...
\begin{frame}
    ...
    \onslide<2->{
    \fu{
        \input{Tikz/spannungsteilerblackbox.tex}
...
\begin{frame}
    ...
    \fu{
        ...
        \begin{minipage}{0.2\textwidth}
            \input{Tikz/transformation1.tex}	
		\end{minipage}
        \hspace{0.1cm}
        \begin{minipage}{0.5\textwidth}
            \input{Tikz/transformation2.tex}	
		\end{minipage}
        \hspace{0.1cm}
        \begin{minipage}{0.2\textwidth}
            \input{Tikz/transformation3.tex}	
		\end{minipage}
        }
...
\begin{frame}
    ...
    \fu{
        ...
        \begin{minipage}{0.3\textwidth}
            \input{Tikz/umwandlungspannungsquelle1.tex}	
		\end{minipage}
        \hspace{0.1cm}
        \begin{minipage}{0.2\textwidth}
            \input{Tikz/umwandlungspannungsquelle2.tex}	
		\end{minipage}
        \hspace{0.1cm}
        \begin{minipage}{0.3\textwidth}
            \input{Tikz/umwandlungspannungsquelle3.tex}		
		\end{minipage}
        \hspace{0.1cm}
        }
    ...
    \fu{
        ...
        \hspace{0.1cm}
        \begin{minipage}{0.3\textwidth}
            \input{Tikz/umwandlungstromquelle1.tex}	
		\end{minipage}
        \hspace{0.1cm}
        \begin{minipage}{0.2\textwidth}
            \input{Tikz/umwandlungstromquelle2.tex}	
		\end{minipage}
        \hspace{0.1cm}
        \begin{minipage}{0.3\textwidth}
            \input{Tikz/umwandlungstromquelle3.tex}		
		\end{minipage}
        \hspace{0.1cm}
        }
...
\begin{frame}
    ...
    \fu{
        \resizebox{.6\textwidth}{!}{%
		\input{Tikz/ueberlagerungssatz.tex}
		}%
...
\begin{frame}
    ...
    \fu{
		...
		\input{Tikz/ueberlagerungssatzquellen.tex}
		}%
...
\begin{frame}
    ...
    \speech{SuperposBsp}{4}{Bei der Netzbetrachtung für die Stromquelle I G wird die Spannungsquelle nun deaktiviert und hinterlässt einen Kurzschluss. 
    Der Gesamtstrom resultiert aus I G und teilt sich am Knoten Ka zwei auf die Ströme I zwei und minus I drei auf. 
    ...
    von R i und R zwei und R zwei und R drei.}
