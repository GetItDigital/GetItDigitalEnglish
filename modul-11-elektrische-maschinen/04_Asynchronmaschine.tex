...
\begin{frame}\ftx{Asynchronmaschine Aufbau}\index{Asynchronmaschine>Aufbau}\s{\subsection{Aufbau}}
	\fo{width=0.65\textwidth}{height=0.88\textheight}{Aufbau_Asynchron_Kaefig1}{
	...
	\speech{AufbauASM}{1}{Die Asynchronmaschine ist wie die Synchronmaschine eine sogenannte Drehfeldmaschine.}
	\silence{5}
	\speech{AufbauASM}{1}{Der Stator ist identisch zum Stator der Synchronmaschine, der Rotor ist hingegen in der häufigsten Version dieses Maschinentyps, dem sogenannten Käfigläufer, passiv.}
	\silence{4}
...
\begin{frame}\ftb{Drehzahl/Drehmomenten-Kennlinie}
	\begin{columns}
		...
		\s{
			\fu{
				\input{Tikz/klosssche_kennlinie.tex}
