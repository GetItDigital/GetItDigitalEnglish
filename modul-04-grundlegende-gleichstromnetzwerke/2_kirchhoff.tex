...
\begin{frame}
	...
	\s{
        ...
        Applied to the example nodes in Figure \ref{fig:knoten34}, this results in the following equations:
...
\begin{frame}
	...
	\s{
		...
		This is illustrated in example \ref{bsp:knoten}.
		...
		between the two nodes changes (example \ref{bsp:knoten2}).. 
...
\begin{frame}
	...
	\s{
		...
		\begin{Key point}{Maschenregel 2}
...
\begin{frame}
	...
	\s{
        ...
        An application case for determining a partial voltage is shown in Example \ref{bsp:reihe}.
        ...
        The mesh rule can also be applied if the mesh to which it is applied has an interruption point (see example \ref{bsp:reihe2}). 
