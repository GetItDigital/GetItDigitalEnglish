...
\immediate\write18{modul-08-schaltungen-variabler-frequenz/Tikz/sh/tikz_externalize.sh}
\immediate\write18{modul-12-schaltvorgaenge/Tikz/sh/tikz_externalize.sh}
...
\newcommand{\GetItDigitalModulname}{}
...
\printnomenclature
\addcontentsline{toc}{chapter}{Verwendete Größen und Formelzeichen}
\cleardoublepage
