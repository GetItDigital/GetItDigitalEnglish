\subsection{Calculation of the output voltage of an operational amplifier circuit with two inputs\label{Aufg4}}
% Alt: Aufgabe 4
\Aufgabe{
    The depicted circuit with an ideal operational amplifier is given. The resistors are $R_\mathrm{1} = \mathrm{100\,k\Omega}$ and $R_2=\mathrm{10\,k\Omega}$. 
    The supply voltage is $\mathrm{\pm 15\,V}$.
    \begin{itemize}
        \item [ a)] Determine the output voltage $U_\mathrm{A}$ bei $U_\mathrm{E}=2\,\mathrm{mV}$ and $U_\mathrm{bat} = \mathrm{0\,V}$
        \item [ b)] Determine the output voltage $U_\mathrm{A}$ bei $U_\mathrm{E}=20\,\mathrm{mV}$ and $U_\mathrm{bat}=\mathrm{0\,V}$
    \end{itemize}
    \begin {figure} [H]
   \centering
   \input{Tikz/src/FigOPV2Eingaenge.tex}
...
\Loesung{
   ...
   \label{fig:LsgOPV2Eingaenge}
    ...
    \end{eqa}
	Rearrange formula according to $U_\mathrm{A}$:
    \begin{align*}
