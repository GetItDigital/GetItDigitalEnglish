\subsection{Use of a Zener diode for voltage stabilisation\label{Aufg6}}
% Alt: Aufgabe 6
\Aufgabe{
  ...
  \begin{itemize}
      \item[a)] Calculate the series resistor \( R_\mathrm{V} \) so that, for an input voltage of \( U_\mathrm{E} = \mathrm{10\,V} \), an output voltage of \( U_\mathrm{A} = \mathrm{8\,V} \) is established.
      \item[b)] What are the powers dissipated in \( R_\mathrm{V} \), \( R_\mathrm{L} \), and in the diode \( D_\mathrm{Z} \)?
 \end{itemize}
