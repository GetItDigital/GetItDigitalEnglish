% RLC-Parallelschwingkreis - Phasenkurve von w/w0 mit Q=1,2,3,4,1000 (phi = phi_I - phi_U bzw. phi=arg(Y))
\def\R{10}%     10 Ohm
\def\L{10e-3}%  10 mH
\def\C{10e-6}%  10 uF
...
\begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \begin{axis}[
        ...
        ylabel style={yshift=-0.45cm},% not 0.45cm but something like 0.1cm
        xmin=0, xmax=3,
        ymin=-95, ymax=95,
        width=12cm,
        height=4cm,
    ...
    % Phi = atan(Im{Y}/Re{Y}) = atan(Bk * (w/w0 - w0/w) / G) = atan( Q * (w/w0 - w0/w)
