...
\Loesung{
	\begin{itemize}	
		...
		\item[\bf b)]
		\begin{equation*}
		    Efficiency = \frac{Energy\ consumed}{Energy\ expended} = \eta
		\end{equation*}
		\begin{equation*}
...
\Loesung{
    \begin{itemize}
        ...
        \item[\bf b)]
        \begin{equation*}
            m = 5\,\mathrm{kg} \quad (\text{Density of water} \approx 1\,\mathrm{kg/L})
        \end{equation*}
        \begin{equation*}
            c = 4186\,\mathrm{\frac{J}{kg \cdot K}} \quad (\text{Specific heat capacity of water})
        \end{equation*}
        \begin{equation*}
