...
\newvideofile{EinleitungEnergieundLeistung1}{EinleitungEnergieundLeistung2}
\begin{frame}
	\ftx{Lernziele: Unterschied von Energie, Arbeit, Leistung} % ToDo: In manchen Lernzielen verrutscht der letzte Buchstabe des Titels in den Text der Infobox
...
Die Lernziele dieses Moduls oder besser gesagt. der folgenden Folien sind die folgenden.
Sie können Energie, elektrische Arbeit, Leistung und den Wirkungsgrad benennen.
Sie verstehen, wie Energie in elektrischen Systemen umgewandelt und genutzt wird.
Sie können die elektrische Arbeit, Leistung und den Wirkungsgrad berechnen.
Und sie können die Effizienz von Energieumwandlungssystemen analysieren.
}
...
\s{
	...
	\begin{figure}[H]
		...
		\speech{00_Einleitung}{2}{ % hier titel einfügen
...
\speech{00_Einleitung}{3}{
	Auch hier nochmal der ganz wichtige Merksatz:
	Energie kann gespeichert werden, Arbeit wird verrichtet.
	Was das bedeutet, haben wir gerade am Beispiel des Pumpspeicherkraftwerks gesehen.
	Wenn Wasser hochgepumpt wird, dann ist die Energie in Form von potenzieller Energie gespeichert.
	Wenn es dann wieder herunterläuft, gibt es diese Energie an das System ab.
	In der Turbine wird Arbeit verrichtet, und dabei wird Energie gewandelt.
}
