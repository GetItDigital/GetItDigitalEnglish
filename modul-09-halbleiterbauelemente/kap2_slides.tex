...
\begin{frame}
    ...
    \speech{Bipolartransistor KSEB}{2}{Diese Folie zeigt das Kleinsignal-Ersatzschaltbild eines Bipolartransistors – in zwei Varianten:
...
\begin{frame}
    ...
    \speech{Bipolartransistor KSEB}{4}{Die Merksätze dazu fassen nochmal das Wichtigste zusammen:
...
\begin{frame}
     ...
     \speech{Aufbau Transistor}{1}{Schauen wir uns einmal den physikalischen Aufbau eines npn-Transistors an. 
...
\begin{frame}
     ...
     \speech{Transistor als Schalter}{2}{Neben seiner Rolle als Verstärker kann der Bipolartransistor auch ganz als elektronischer Schalter eingesetzt werden.
...
\begin{frame}
    ...
    \speech{Transistor als Schalter}{3}{Im Vergleich zu mechanischen Schaltern sind Transistoren deutlich kleiner und potenziell günstiger. Ein weiterer wichtiger Vorteil ist, dass bei mechanischen Schaltern ein sogenanntes Kontaktprellen auftreten kann, was den Schalter verschleißt und die Signalqualität verschlechtert. Bei Transistoren gibt es dieses Prellen nicht.}
\end{frame}
